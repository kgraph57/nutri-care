...
export const MENU_TEMPLATES: readonly MenuTemplate[] = [
  // ── 成人 経腸栄養 ──
  {
    ...
    name: "成人標準経腸栄養",
    description: "一般的な入院患者向け。1.0kcal/mL経腸栄養剤 1500mL/日",
  ...
  },
  {
    ...
    nutritionType: "enteral",
    category: "disease",
    items: [{ productKeyword: "リーナレン", volume: 200, frequency: 3 }],
    condition: "腎不全（保存期）",
    tags: ["経腸", "腎不全", "電解質制限", "低蛋白"],
    targetEnergy: 1200,
    targetProtein: 40,
    caution:
      "電解質（K・P・Na）を定期モニタリングのこと。蛋白過剰投与は腎機能悪化リスクあり。",
  },
  {
    id: "adult-hepatic-en",
    name: "肝不全用経腸栄養",
    ...
    nutritionType: "enteral",
    category: "disease",
    items: [{ productKeyword: "アミノレバン", volume: 200, frequency: 3 }],
    condition: "肝硬変・肝性脳症",
    tags: ["経腸", "肝不全", "BCAA強化"],
    targetEnergy: 1200,
    targetProtein: 60,
  ...
  },
  {
    ...
    nutritionType: "enteral",
    category: "disease",
    items: [{ productKeyword: "グルセルナ", volume: 200, frequency: 3 }],
    condition: "糖尿病",
  ...
  },
  {
    ...
    nutritionType: "enteral",
    category: "disease",
    items: [{ productKeyword: "プルモケア", volume: 250, frequency: 3 }],
    condition: "呼吸不全・ARDS",
    tags: ["経腸", "呼吸不全", "低糖質", "高脂質"],
    targetEnergy: 1500,
    targetProtein: 65,
    caution:
      "過剰カロリーはCO2産生増加を招くため、目標カロリーを厳守すること。",
  },
  ...
  // ── 小児 ──
  {
    ...
    nutritionType: "enteral",
    category: "pediatric",
    items: [{ productKeyword: "エンシュア", volume: 100, frequency: 4 }],
    tags: ["経腸", "小児", "標準"],
    targetEnergy: 800,
    targetProtein: 30,
  },
  {
    ...
    nutritionType: "enteral",
    category: "pediatric",
    items: [{ productKeyword: "母乳強化", volume: 20, frequency: 8 }],
    condition: "低出生体重児（NICU）",
    tags: ["経腸", "NICU", "低出生体重児"],
    targetEnergy: 120,
    caution:
      "体重当たりエネルギー目標（110〜130 kcal/kg/日）を個別に設定すること。",
  },
  ...
  // 1. 熱傷・高カロリー
  {
    ...
    targetProtein: 120,
    caution:
      "Curreri式または間接熱量測定でカロリー目標を個別設定。電解質・血糖を頻回モニタリングのこと。",
  },
  ...
  // 2. Refeeding症候群予防
  {
    ...
    description:
      "長期絶食・低栄養患者への段階的カロリー投与（低カロリー開始→漸増）",
    nutritionType: "parenteral",
    category: "disease",
    items: [
    ...
    targetProtein: 20,
    caution:
      "開始時は10 kcal/kg/日以下から。P・K・Mgを毎日測定し低下時は補充。チアミン（Vit B1）を開始前に必ず投与。",
  },
  ...
  // 3. 腎不全・透析中
  {
    ...
    name: "透析患者経腸栄養",
    description:
      "血液透析中の腎不全患者向け。蛋白は透析による消失分を加味し増量",
    nutritionType: "enteral",
    category: "disease",
    items: [
    ...
    targetProtein: 70,
    caution:
      "透析非施行日と施行日でK・P摂取量を調整。透析中の蛋白喪失（約10g/回）を補うため保存期より蛋白量を増やす。",
  },
  ...
  // 4. 心不全・水分制限
  {
    ...
    nutritionType: "enteral",
    category: "disease",
    items: [{ productKeyword: "イノラス", volume: 150, frequency: 3 }],
    condition: "心不全（水分制限 1000〜1500 mL/日）",
    tags: ["経腸", "心不全", "水分制限", "高濃度"],
    targetEnergy: 1200,
    targetProtein: 50,
    caution:
      "1日総水分量（静注・内服・栄養剤）を合算して制限内に収める。体重・浮腫・尿量を毎日確認。Na制限（<2g/日）も並行管理。",
  },
  ...
  // 5. 呼吸不全TPN（経腸困難例）
  {
    ...
    targetProtein: 65,
    caution:
      "過剰なブドウ糖投与はCO2産生増加・呼吸商上昇を招く。間接熱量測定によるRQ管理が望ましい。",
  },
  ...
  // 6. 糖尿病TPN
  {
    ...
    name: "糖尿病TPN（血糖管理強化）",
    description:
      "インスリン抵抗性を考慮し糖質を抑えた静脈栄養、血糖140mg/dL未満を目標",
    nutritionType: "parenteral",
    category: "disease",
    items: [
    ...
    targetProtein: 55,
    caution:
      "血糖140〜180 mg/dLを目標にインスリンで管理。低血糖（<70 mg/dL）にも注意。1〜2時間ごとの血糖測定を推奨。",
  },
  ...
  // 7. 小児PICU標準
  {
    ...
    nutritionType: "enteral",
    category: "pediatric",
    items: [{ productKeyword: "エンシュア", volume: 100, frequency: 5 }],
    condition: "小児集中治療（PICU）",
    tags: ["経腸", "小児", "PICU", "標準"],
    targetEnergy: 1000,
    targetProtein: 35,
    caution:
      "年齢・体重による目標エネルギー（40〜60 kcal/kg/日）を個別設定。消化管耐性を確認しながら増量すること。",
  },
  ...
  // 8. NICU超早産児TPN
  {
    ...
    name: "NICU超早産児TPN",
    description:
      "在胎28週未満の超早産児向けTPN。アミノ酸・脂質の早期投与で成長を促進",
    nutritionType: "parenteral",
    category: "pediatric",
    items: [
    ...
    targetProtein: 4,
    caution:
      "エネルギー目標110〜120 kcal/kg/日、蛋白3.5〜4.5 g/kg/日を体重換算で設定。脂質は0.5 g/kg/日から開始し漸増。高血糖・電解質異常を毎日確認。",
  },
  ...
  // 9. 周術期TPN
  {
    ...
    targetProtein: 55,
    caution:
      "経腸栄養が可能になり次第、早期に移行すること。感染リスク低減のため中心静脈カテーテル管理に留意。",
  },
  ...
  // 10. 肝硬変BCAA強化
  {
    ...
    name: "肝硬変BCAA強化経腸栄養",
    description:
      "肝硬変Child C症例へのBCAA強化製剤。就寝前軽食（LES）も考慮した処方",
    nutritionType: "enteral",
    category: "disease",
    items: [
    ...
    targetProtein: 50,
    caution:
      "就寝前200 kcal程度の軽食（LES）が有効。芳香族アミノ酸過剰による肝性脳症悪化に注意。NH3値を定期測定。",
  },
] as const;
