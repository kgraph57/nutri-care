...
// ─── P008 中村恵子（ARDS）─── 低Alb, 高CRP, 軽度腎障害
const P008_LAB: LabData[] = [
  {
    patientId: "P008",
    date: daysAgoDate(4),
    albumin: 2.2,
...
// ─── P013 吉田翔太（8歳 虫垂穿孔）─── 術後高CRP→改善、軽度脱水
const P013_LAB: LabData[] = [
  {
    patientId: "P013",
    date: daysAgoDate(3),
    albumin: 2.8,
...
export const allSampleLabData: readonly LabData[] =
  Object.values(sampleLabDataMap).flat();
