...
import { Card, ProgressBar, AdequacyScoreBadge } from "../../components/ui";
...
function Electrolytes({
  ...
  const electrolytes = [
    ...
    { key: "calcium", label: "Ca", unit: "mEq/日", reqKey: "calcium" as const },
    {
      ...
      label: "Mg",
      unit: "mEq/日",
      reqKey: "magnesium" as const,
    },
    {
      key: "phosphorus",
      label: "P",
      unit: "mEq/日",
      reqKey: "phosphorus" as const,
    },
    {
      key: "chloride",
      label: "Cl",
      unit: "mEq/日",
      reqKey: "chloride" as const,
    },
  ] as const;
  ...
  if (!requirements) {
    return (
      <Card className={styles.card}>
        ...
        <p className={styles.placeholder}>患者を選択してください</p>
      </Card>
    );
  }

  const adequacy = useMemo(
    () => calculateAdequacyScore(requirements, currentIntake),
    [requirements, currentIntake],
  );
  ...
  return (
    <Card className={styles.card}>
      <div className={styles.headingRow}>
        ...
        <AdequacyScoreBadge score={adequacy.overall} size="sm" />
      </div>
