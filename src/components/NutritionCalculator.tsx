...
const NutritionCalculator: React.FC<NutritionCalculatorProps> = ({
  ...
  const [calculationResults, setCalculationResults] =
    useState<NutritionCalculation | null>(null);
  ...
  const calculateNutrition = () => {
    ...
    if (selectedPatient.gender === "男性") {
      bmr =
        66.5 +
        13.75 * selectedPatient.weight +
        5.003 * selectedPatient.height -
        6.775 * selectedPatient.age;
    } else {
      bmr =
        655.1 +
        9.563 * selectedPatient.weight +
        1.85 * selectedPatient.height -
        4.676 * selectedPatient.age;
    }
