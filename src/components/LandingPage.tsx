...
const highlightCards = [
  {
    ...
    title: "ログイン不要ですぐに利用",
    description:
      "初回アクセスからそのまま入力可能。端末ローカルに保存し、医療施設のネットワーク制限にも対応します。",
  ...
  },
  {
    ...
    title: "AIが解説も添付",
    description:
      "Nani翻訳のUXを踏襲し、数値根拠と注意点を注釈付きで提示。スタッフ間の理解を揃えます。",
  ...
  },
  {
    ...
    description:
      "栄養計画書やラボ結果をアップロードして要点抽出。ショートカット一発で共有可能です。",
...
const downloadCards = [
  {
    ...
    description:
      "ショートカットから瞬時に呼び出せるmacOS / Windowsアプリ。電子カルテと並行利用できます。",
    cta: "アプリを入手",
    href: "#",
    badge: "推奨",
  },
  {
    title: "Web版で試す",
    description:
      "ブラウザだけで利用可能。ログイン不要で即スタートでき、保存データは端末内に保持します。",
    cta: "ブラウザで開く",
    href: "#",
    badge: "無料",
  },
...
const languageItems = [
  {
    name: "English",
    description: "医療英語にも対応し、和訳と注釈を瞬時に生成。",
  },
  ...
  {
    name: "简体中文",
    description: "主要学会資料に合わせた翻訳ガイドラインを反映。",
  },
];
...
const testimonialItems = [
  {
    ...
    author: "東京大学医学部附属病院 栄養管理チーフ",
  },
  {
    quote:
      "夜間当直でもダッシュボードから状況が把握でき、チームでの意思決定が圧倒的に速くなりました。",
    author: "大阪市立総合医療センター 栄養サポートチーム",
  },
  {
    quote:
      "ショートカット呼び出しとローカル保存。Naniの思想をそのまま医療現場に持ち込めています。",
...
const updatePosts = [
  {
    ...
    description:
      "ワンクリックでNani風の翻訳モーダルを呼び出し、院内マニュアルを展開できます。",
    href: "#",
  },
  {
    title: "AIサマリーに臨床栄養ガイドラインを反映",
    description:
      "ESPEN / ASPENの最新推奨を自動で参照し、根拠リンクを添付するようになりました。",
    href: "#",
  },
  {
    title: "画像解析で手書きメモに対応",
    description:
      "紙カルテの写真をアップロードすると、そのまま翻訳と栄養計算が行えます。",
    href: "#",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "不要です。Naniと同じく、アプリを起動した瞬間から翻訳・栄養提案が利用できます。設定は端末ローカルに安全に保存されます。",
  },
  {
  ...
  return (
    <div className="landing-root">
      <div className="landing-banner">
        ...
        今なら医療機関向け早期導入プランを提供中。
        <button type="button">資料をダウンロード</button>
      </div>
      <header className="landing-header">
        <div className="landing-nav">
          ...
          <div className="landing-nav-links">
            ...
            <button
              type="button"
              onClick={() => setCurrentView("food-database")}
            >
              栄養データベース
            </button>
          </div>
          ...
          <div className="landing-actions">
            ...
            <button
              ...
              onClick={() => setCurrentView("modern-dashboard")}
            >
      ...
      <main className="landing-main">
        <section className="landing-hero">
          <div>
            ...
            <h1 className="landing-hero-title">
              翻訳アプリの体験で、栄養管理をもっと速く。
            </h1>
            <p className="landing-hero-description">
              Nani翻訳のUIUXをそのまま医療現場へ。入力 → AI解析 →
              共有が一画面で完結し、チームの意思決定を加速します。
            </p>
            <div className="landing-hero-buttons">
              ...
              <button
                type="button"
                className="landing-action-secondary"
                onClick={() => setCurrentView("nutrition-menus")}
              >
                保存メニューを見る
              </button>
              <button
                type="button"
                className="landing-action-secondary"
                onClick={() => setCurrentView("nutrition-calc")}
              >
                栄養計算に進む
              </button>
            </div>
          ...
          <div className="landing-hero-panel">
            ...
            <div className="landing-panel-body">
              <div className="landing-panel-input">
                <span className="landing-panel-label">臨床ノート</span>
              ...
              <div className="landing-panel-output">
                ...
                <p className="landing-panel-text">
                  ・推奨エネルギー 1850kcal/日 (30kcal/kg)
                  <br />
                  ・たんぱく質 1.3g/kg → 78g/日前後
                  <br />
            ...
            <div className="landing-panel-actions">
              <button
                type="button"
                className="landing-panel-button"
                onClick={() => setCurrentView("nutrition-calc")}
              >
                目標量を再計算
              </button>
          ...
          <div className="landing-highlight-grid">
            {highlightCards.map((card) => (
              <article
                ...
                onClick={() => setCurrentView(card.action)}
              >
        ...
        <section id="pricing" className="landing-pricing-section">
          <div className="landing-pricing-header">
            <h2>料金プラン</h2>
            <p>
              Naniの価格表と同じく、最初は無料で始められます。必要に応じてPro /
              Enterpriseへアップグレード。
            </p>
          </div>
          <div className="landing-pricing-grid">
            {pricingPlans.map((plan) => (
              <article
                key={plan.name}
                className={`landing-pricing-card${plan.highlight ? " is-highlight" : ""}`}
              >
                {plan.highlight && (
                  <span className="landing-pricing-badge">人気</span>
                )}
                <h3>{plan.name}</h3>
        ...
        <section id="testimonials" className="landing-testimonial-section">
          <div className="landing-testimonial-header">
            <h2>導入医療機関の声</h2>
            <p>
              Naniの「ユーザーの声」セクションに倣い、導入後の変化を紹介します。
            </p>
          </div>
        ...
        <section id="updates" className="landing-updates-section">
          <div className="landing-updates-header">
            <h2>更新情報</h2>
            <p>
              NaniがブログやXで共有しているアップデートを模倣し、最新機能をまとめています。
            </p>
          </div>
        ...
        <section id="workflow" className="landing-info-section">
          ...
          <div className="landing-info-panel">
            ...
            <p>
              Turso +
              Upstashを用いた低遅延キャッシュ、Next.jsとElectronを共通化するモノレポ構成など、Zenn記事
              <a
                href="https://zenn.dev/catnose99/articles/nani-translate"
                target="_blank"
                rel="noreferrer"
              >
                「Nani翻訳の技術的な話」
            ...
            <p>
              macOS /
              Windowsアプリではショートカット起動、Web版ではブラウザのみで体験可能。翻訳データと同様に栄養提案も端末側に保存され、サーバーには残りません。
            </p>
        ...
        <section id="security" className="landing-info-section">
          <div className="landing-info-panel">
            <h3>セキュリティとプライバシー</h3>
            <p>
              入力データは端末上に安全に保存され、運営スタッフが閲覧することはありません。処理のために送信された情報はGoogle
              / OpenAI / Groqで短期間のみ保持され、自動削除されます。
          ...
          <div className="landing-info-panel">
            <h3>対応環境</h3>
            <p>
              Web版はブラウザだけで利用可能。macOS (Apple Silicon / macOS 14+)
              とWindowsアプリでは、他アプリからのショートカット翻訳、画像やPDFのドラッグ＆ドロップ解析にも対応しています。
            </p>
            <div className="landing-info-tags">
        ...
        <section id="languages" className="landing-languages-section">
          <div className="landing-languages-header">
            <h2>対応言語</h2>
            <p>
              チーム構成に合わせて柔軟に拡張中。翻訳と同時に栄養評価サマリーを生成します。
            </p>
          </div>
      ...
      <footer className="landing-footer">
        ...
        <div className="landing-footer-links">
          ...
          <a href="mailto:hello@nutri-care.example">お問い合わせ</a>
        </div>
      </footer>
    </div>
  );
